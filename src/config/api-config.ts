/**
 * Centralized API Configuration for NOVAPRIME
 *
...
export const API_CONFIG = {
    ...
    APP_ID: process.env.DERIV_APP_ID || '125428',
...
export const getWebSocketURL = (
    ...
    const storedEndpoint = typeof window !== 'undefined' ? localStorage.getItem('deriv_server_endpoint') : null;

    const selectedEndpoint =
        (storedEndpoint as keyof typeof API_CONFIG.WEBSOCKET_ENDPOINTS) || endpoint || API_CONFIG.DEFAULT_ENDPOINT;
